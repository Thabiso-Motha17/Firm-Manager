      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card>
          <CardContent className="p-6">
            ...
            <p className="text-2xl font-semibold text-foreground">${billingOverview.currentBalance.toLocaleString()}</p>
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <p className="text-2xl font-semibold text-foreground">${billingOverview.totalBilled.toLocaleString()}</p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <p className="text-2xl font-semibold text-foreground">${billingOverview.totalPaid.toLocaleString()}</p>
          </CardContent>
        </Card>
