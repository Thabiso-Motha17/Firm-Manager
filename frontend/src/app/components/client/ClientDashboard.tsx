  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="hover:border-accent/50 transition-colors cursor-pointer" onClick={() => onNavigate('documents')}>
          <CardContent className="p-6">
        ...
        <Card className="hover:border-accent/50 transition-colors cursor-pointer" onClick={() => onNavigate('messages')}>
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
        ...
        <Card className="hover:border-accent/50 transition-colors cursor-pointer" onClick={() => onNavigate('billing')}>
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
            ...
            <h3 className="text-2xl font-semibold text-foreground mb-1">$2,450</h3>
