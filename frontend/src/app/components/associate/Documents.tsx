...
const folders = [
  { name: 'Legal Filings', count: 8, icon: Folder },
  { name: 'Contracts', count: 12, icon: Folder },
  { name: 'Discovery', count: 5, icon: Folder },
  { name: 'Estate Planning', count: 6, icon: Folder },
  { name: 'Evidence', count: 15, icon: Folder },
  { name: 'Internal Documents', count: 23, icon: Folder }
];
